...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column("package_activity_id", UuidType, sa.ForeignKey("activity.id"), nullable=False),
    ...
    op.create_unique_constraint("package_version_key", "package_version", ["id", "name"])
