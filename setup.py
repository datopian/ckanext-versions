...
setup(
    ...
    url='https://github.com/datopian/ckanext-versions',
    ...
    entry_points={
        'ckan.plugins': [
            'versions = ckanext.versions.plugin:VersionsPlugin'
        ],
        'paste.paster_command': [
            'versions = ckanext.versions.commands:VersionsCommand'
        ],
        'babel.extractors': [
